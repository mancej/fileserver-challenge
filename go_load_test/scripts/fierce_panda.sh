...
export MAX_FILE_COUNT=5000                     # Recommend 2-5x total REQUESTS_PER_SECOND (consider seed in this calculation)
export MAX_FILE_SIZE=1024                      # 1KB, but could be set to ANYTHING in live tests
export MAX_WRITES_PER_CADENCE=50               # Hard cap on max # of file writes per seed cadence
