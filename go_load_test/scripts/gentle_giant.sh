...
export RANDOMLY_UPLOAD_LARGE_FILES=false       # If true, 1 out of every 1000 files uploaded will be > 100MB in size
export MAX_FILE_COUNT=1000                     # Recommend 2-5x total REQUESTS_PER_SECOND (consider seed in this calculation)
export MAX_FILE_SIZE=128                       # 1KB, but could be set to ANYTHING in live tests
export MAX_WRITES_PER_CADENCE=60               # Hard cap on max # of file writes per seed cadence
