...
export RANDOMLY_UPLOAD_LARGE_FILES=true        # If true, 1 out of every 1000 files uploaded will be > 100MB in size
export MAX_FILE_COUNT=10000                    # Recommend 2-5x total REQUESTS_PER_SECOND (consider seed in this calculation)
